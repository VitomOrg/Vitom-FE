import ContentSection from "@/views/main-layout/contact-page/components/content";
import FormContact from "@/views/main-layout/contact-page/components/form_contact";
